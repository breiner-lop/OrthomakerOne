          ...
          <div className="bg-white p-4 rounded-lg">
            ...
            <div className="flex text-center my-4">
              ...
              <div>
                ...
                <br />
                <h4 className="text-xs text-gray-400 mt-2">Orden cancelada</h4>
              </div>
              <div>
                <span className="text-3xl">12</span>
                <br />
                <h4 className="text-xs text-gray-400 mt-2">Nuevas ordenes</h4>
              </div>
              <div>
                <span className="text-3xl">5</span>
                <br />
                <h4 className="text-xs text-gray-400 mt-2">Ordenes en envio</h4>
              </div>
            </div>
          </div>
        </div>
