  ...
  return (
    <div className="px-24">
      ...
      <div className="flex justify-between text-purple-dark h-20 items-center">
            ...
            <div className="flex">
              {wompiLoading&&<button className="bg-purple-dark text-white rounded-lg w-48 h-11 font-semibold shadow-md hover:shadow hover:bg-opacity-95 transition duration-200 flex justify-center items-center" onClick={()=>{checkout.open(function(r){})}}>Realizar pago</button>}
      ...
      <div className="border border-gray-300  shadow-lg bg-white bg-opacity-75 rounded-lg px-6">
          <div className="text-center border-b border-gray-300 py-6"><span className="text-2xl">Detalles de la orden</span></div>
           ...
           <h4 className="text-xl text-center">Datos de la protesis</h4>
           {
              ...
              <div className="flex justify-center">
               <div>
               <CampoDetalleOrden title="Extremidad amputada" valor={dataProthesis.prothesisData.ext_emputee} widthTitle="w-32"/>
                <CampoDetalleOrden title="Medida A-B" valor={dataProthesis.prothesisData.medidaAB/10+" cm"} widthTitle="w-32"/>
                <CampoDetalleOrden title="Medida B-C" valor={dataProthesis.prothesisData.medidaBC/10+" cm"} widthTitle="w-32"/>
               </div>
                </div>
                <div className="flex justify-center">
                <div>
                <CampoDetalleOrden title="Tamaño de la mascota" valor={dataProthesis.prothesisData.pet_size+" cm"} widthTitle="w-44"/>
                <CampoDetalleOrden title="Perimetro del muñon (inferior)" valor={dataProthesis.prothesisData.stump_perimeter_inf+" cm"} widthTitle="w-44"/>
                <CampoDetalleOrden title="Perimetro del muñon (superior)" valor={dataProthesis.prothesisData.stump_perimeter_sup+" cm"} widthTitle="w-44"/>
                </div>
                </div>
              </div>
            }
