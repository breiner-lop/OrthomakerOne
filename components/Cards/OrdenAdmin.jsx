...
export default function OrdenCardAdmin({id,total,date,count}) {
  // Coin converter
  ...
  return (
   <div>
   {
     ...
     <div className="bg-white rounded-lg text-center h-20 px-6 grid grid-cols-10 items-center my-2 cursor-pointer border border-transparent hover:border-gray-200 filter drop-shadow-lg">
