  ...
  return (
    ...
    <div className="mx-auto md:flex hidden justify-between h-32 items-center pb-2 px-5 md:px-14 xl:px-24" style={{maxWidth:"1500px"}}>
     ...
     <div className="flex justify-between items-center w-full">
      ...
      <GetStarted />
     {
       token? <Account/>:<Link href="/login"><button className="font-semibold text-purple-dark border-2 filter drop-shadow-md border-purple ml-2 w-40 h-10 rounded-3xl bg-transparent hover:text-white hover:bg-purple-dark transition duration-300 flex justify-center items-center cursor-pointer">Log in</button></Link>
     }
      </div>
    </div>}
    </div>
