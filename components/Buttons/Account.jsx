...
export default function Account() {
   ...
   const {setPopup,popup}=useCasosCtx()
    ...
    return (
        <div>
            <button onClick={()=>setPopup({...popup,state:!popup.state})} className='ml-4 filter border-none drop-shadow-xl hover:bg-gray-50 hover:shadow-md transition duration-300 rounded-full'>
